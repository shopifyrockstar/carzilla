...
window.theme = window.theme || {}, theme.Sections = function() {
    ...
    return y.prototype = _.assignIn({}, y.prototype, {
        ...
        _products: function(i) {
            0 < $(".products-carousel-megamenu").length && $(".products-carousel-megamenu").each(function(i) {
                if($("body").attr("data-productscarousel") == "true") {
                    return false
                }
                ...
                if (i > 2) {
                    $("body").attr('data-productscarousel', 'true');
                }
            })
        },
