...
var roar = {
        ...
        fixedHeaderMenu: function() {
            if (0 < $(".section-megamenu-content").length && $(".section-megamenu-content").each(function() {
                ...
                y.insertAfter(".megamenu-background"), $(".megamenu-background").clone().appendTo("#header-phantom"), roar.fixedMenu(), $(window).resize(function() {
                    roar.fixedMenu()
                ...
                var y = $("<div id=\"header-phantom\" class=\"fixed-header-1 sticky-header\"></div>");
                y.insertAfter("#top"), $("#top").clone().appendTo("#header-phantom"), roar.fixedHeader(), $(window).resize(function() {
                    roar.fixedHeader()
                }), $(window).scroll(function() {
                    roar.fixedHeader()
                })
        ...
        fixedMenu: function() {
            ...
            $("header #top .background").first().width() != $("header").first().width() && $(".sticky-header").css("background", "none"), $(".sticky-header").css("width", y).css("left", "50%").css("right", "auto").css("margin-left", "-" + Math.ceil(y / 2) + "px").css("margin-right", "-" + Math.ceil(y / 2) + "px"), 1160 <= roar.getWidthBrowser() && 280 < $(window).scrollTop() ? $(".sticky-header").addClass("fixed-header") : $(".sticky-header").removeClass("fixed-header")
            $('#header-phantom .products-carousel-megamenu[data-_id=rt0_3]').attr('data-_id', 'rt0_3_1')
            $('#header-phantom .products-carousel-megamenu #productsCarouselrt0_3').removeClass('productsCarouselrt0_3')
            $('#header-phantom .products-carousel-megamenu #productsCarouselrt0_3').addClass('productsCarouselrt0_3_1')
            $('#header-phantom .products-carousel-megamenu #productsCarouselrt0_3_next').removeClass('productsCarouselrt0_3_next')
            $('#header-phantom .products-carousel-megamenu #productsCarouselrt0_3_next').addClass('productsCarouselrt0_3_1_next')
            $('#header-phantom .products-carousel-megamenu #productsCarouselrt0_3_prev').removeClass('productsCarouselrt0_3_prev')
            $('#header-phantom .products-carousel-megamenu #productsCarouselrt0_3_prev').addClass('productsCarouselrt0_3_1_prev')
            $('#header-phantom .products-carousel-megamenu[data-_id=rt0_4]').attr('data-_id', 'rt0_4_1')
            $('#header-phantom .products-carousel-megamenu #productsCarouselrt0_4').removeClass('productsCarouselrt0_4')
            $('#header-phantom .products-carousel-megamenu #productsCarouselrt0_4').addClass('productsCarouselrt0_4_1')
            $('#header-phantom .products-carousel-megamenu #productsCarouselrt0_4_next').removeClass('productsCarouselrt0_4_next')
            $('#header-phantom .products-carousel-megamenu #productsCarouselrt0_4_next').addClass('productsCarouselrt0_4_1_next')
            $('#header-phantom .products-carousel-megamenu #productsCarouselrt0_4_prev').removeClass('productsCarouselrt0_4_prev')
            $('#header-phantom .products-carousel-megamenu #productsCarouselrt0_4_prev').addClass('productsCarouselrt0_4_1_prev')
        ...
        searchAutoComplete: function() {
            ...
            $("form[action=\"/search\"]").each(function() {
                ...
                0 < S.length && 0 < I.length && $(S).bind("change", function() {
                    $(I).val($(this).val()), C = $(this).val()
                });
                var T = $(this).find("input[name=\"q\"]");
                $("<ul class=\"ui-autocomplete ui-front\"></ul>").appendTo($(this).find(".autocomplete-results")).hide(), T.attr("autocomplete", "off").bind("keyup change", function() {
                    var P = $(this).val(),
                        z = $(this).closest("form"),
                        A = "/search?type=" + C + "&q=*" + P + "*",
                        q = z.find(".ui-autocomplete");
                    3 <= P.length && P != $(this).attr("data-old-term") && (T.addClass("ui-autocomplete-loading"), $(this).attr("data-old-term", P), null != y && y.abort(), y = $.getJSON(A + "&view=json", function(M) {
                        T.removeClass("ui-autocomplete-loading"), q.empty(), 0 == M.results_count ? q.hide() : ($.each(M.results, function(O, N) {
                            var E = $("<a></a>").attr("href", N.url);
                            E.append("<span class=\"thumbnail\"><img src=\"" + N.thumbnail + "\" /></span>"), E.append("<span class=\"title\">" + N.title + "</span>"), E.wrap("<li></li>"), q.append(E.parent())
                        }), 1 < M.results_count && q.append("<li><span class=\"title\"><a href=\"" + A + "\">" + window.all_results_text + " (" + M.results_count + ")</a></span></li>"), q.fadeIn(200))
                    }))
                })
        ...
        currenciesCallback: function() {
            try {
                window.show_multiple_currencies && (Currency.format = window.formatCurrency, Currency.money_with_currency_format[window.shopCurrency] = window.jsonCurrency, Currency.money_format[window.shopCurrency] = window.jsonMoney, window.defaultCurrency = window.defaultCurrency || window.shopCurrency, window.cookieCurrency = Currency.cookie.read(), $("span.money span.money").each(function() {
                    $(this).parents("span.money").removeClass("money")
                }), $("span.money").each(function() {
                    $(this).attr("data-currency-" + window.shopCurrency, $(this).html())
                }), null == window.cookieCurrency ? (window.shopCurrency === window.defaultCurrency ? Currency.currentCurrency = window.defaultCurrency : Currency.convertAll(window.shopCurrency, window.defaultCurrency), Currency.cookie.write(window.defaultCurrency)) : $(".currencies_src").size() && 0 === $(".currencies_src a[data-value=" + cookieCurrency + "]").size() ? (Currency.currentCurrency = window.shopCurrency, Currency.cookie.write(window.shopCurrency)) : window.cookieCurrency === window.shopCurrency ? Currency.currentCurrency = window.shopCurrency : (Currency.convertAll(window.shopCurrency, window.cookieCurrency), $(".currency_code").html(window.cookieCurrency)), $(".currencies_src a").click(function() {
        ...
        currenciesCallbackSpecial: function(y) {
            try {
                window.show_multiple_currencies && (Currency.format = window.formatCurrency, $(y).each(function() {
                    $(this).attr("data-currency-" + window.shopCurrency, $(this).html())
        ...
        handleCookie: function() {
            function C() {
                ...
                try {
                    ...
                    if (0 < document.cookie.length) {
                        ...
                        if (-1 != T) {
                            ...
                            return -1 == P && (P = document.cookie.length), unescape(document.cookie.substring(T, P))
                        }
                    }
                } catch (z) {
                ...
                C(), $("#cookie.cookie").length ? $("#cookie").fadeOut("slow") : $("#cookie.popup").length && $.magnificPopup.close()
            }))
        },
        handleBlog: function() {
            function y(I) {
            ...
            if ($("body").hasClass("templateBlog")) {
                var S = {};
                $(".posts").hasClass("posts-grid") && C(), $("#load-more").click(function() {
                    ...
                    $.ajax({
                        ...
                        success: function(T) {
                            ...
                            }, 500)) : $(".posts").append($(T).find(".posts").html()), $("#load-more").attr("data-page", parseInt(++I)), void y(I))
                        }
                    })
                })
            }
        ...
        handleCompareEvent: function() {
            ...
            y.on("click", "a.add_to_compare", function() {
                ...
                if (z = null != z && "" != z ? z.split(",") : [], 0 > z.indexOf(T) && !1 === $(this).hasClass("added")) {
                    z.push(T);
                    var A = z.join(",");
                    "," == A.substring(0, 1) && (A = A.substring(1)), Currency.cookie.rtwrite("rt-compare", A)
                }!1 === $(this).hasClass("added") || "" == P ? (P = "", $.ajax({
                    url: "/pages/compare/" + z,
                    dataType: "html",
                    type: "GET",
                    success: function(q) {
                    ...
                    complete: function() {
                        $.magnificPopup.open({
                            ...
                            callbacks: {
                                open: function() {
                                    $("[data-pid=\"" + T + "\"]").addClass("added").attr("title", $("[data-pid=\"" + T + "\"]").attr("data-added")), $("[data-pid=\"" + T + "\"]").find("span").html($("[data-pid=\"" + T + "\"]").attr("data-add")), window.show_multiple_currencies && roar.currenciesCallbackSpecial(".compare-content span.money"), roar.handleReviews(), roar.handleCompareScroll()
                                }
                            }
                        })
                    }
                    ...
                    complete: function() {
                        $.magnificPopup.open({
                            ...
                            callbacks: {
                                open: function() {
                                    window.show_multiple_currencies && roar.currenciesCallbackSpecial(".compare-content span.money"), roar.handleReviews(), roar.handleCompareScroll()
                                }
                            }
                        })
                    }
                ...
                var T = $(this),
                    P = T.attr("data-rev"),
                    z = $(".compare-content");
                $("[data-pid=\"" + P + "\"]").removeClass("added").attr("title", $("[data-pid=\"" + P + "\"]").attr("data-add")), $("[data-pid=\"" + P + "\"]").find("span").html($("[data-pid=\"" + P + "\"]").attr("data-add"));
                var A = decodeURI(Currency.cookie.rtread("rt-compare"));
                null != A && (A = A.split(",")), A = jQuery.grep(A, function(q) {
                    return q != P
                }), A = $.trim(A), Currency.cookie.rtwrite("rt-compare", A), $(".fastor_" + P).remove(), 0 >= A.length && $(".mfp-close").trigger("click")
            })
        },
        autoloadCompare: function() {
            if (0 != parseInt(theme.compare)) {
                var y = Currency.cookie.rtread("rt-compare");
                null == y ? y = [] : (y = y.split(","), y.map(function(C) {
                    $("[data-pid=\"" + C + "\"]").addClass("added").attr("title", $("[data-pid=\"" + C + "\"]").attr("data-added")), $("[data-pid=\"" + C + "\"]").find("span").html($("[data-pid=\"" + C + "\"]").attr("data-added"))
                }))
            }
        },
        handleCompareScroll: function() {
            jQuery("#be_compare_features_table").on("scroll", function() {
                ...
                jQuery(this).scrollLeft() + jQuery(this).innerWidth() >= jQuery(this)[0].scrollWidth ? y.hasClass("scroll-right") && y.removeClass("scroll-right") : 0 === jQuery(this).scrollLeft() ? y.hasClass("scroll-left") && y.removeClass("scroll-left") : (!y.hasClass("scroll-right") && y.addClass("scroll-right"), !y.hasClass("scroll-left") && y.addClass("scroll-left"))
        ...
        removeToWishlist: function() {
            $(document).on("click", ".remove-wishlist", function(y) {
                ...
                return I = S.serialize() + "&" + $.param(I), $.ajax({
                    type: "POST",
                    url: "/a/wishlist",
                    async: !0,
                    cache: !1,
                    ...
                    success: function(T) {
                        1 == T.code ? C.closest(".item").slideUp("fast", function() {
                            C.closest(".item").remove(), $(".page-wishlist .infos").removeClass("hide"), $(".wishlist_items_number").text(T.json), 0 == T.json && $(".wishlist-empty").removeClass("hide")
        ...
        addToWishlist: function() {
            $(document).on("click", ".add-to-wishlist:not(.added)", function() {
                ...
                return T = I.serialize() + "&" + $.param(T), $.ajax({
                    type: "POST",
                    url: "/a/wishlist",
                    async: !0,
                    cache: !1,
                    ...
                    complete: function() {
                        S.hasClass("btooltip") && S.removeClass("loading"), $(".wishlist" + S.prev().val()).attr("title", S.attr("data-added")).addClass("added").find("span").text(S.attr("data-added"))
                    },
                    error: function(P) {
        ...
        handlePopups: function() {
            function y() {
                if (0 == window.popup_mailchimp_expire ? $("#popup-mailchimp .dont-show-me").change(function() {
                        $(this).is(":checked") ? C() : S()
                    }) : 1 == window.popup_mailchimp_expire && S(), !I()) {
                    ...
                    }, T), 2 == window.popup_mailchimp_expire && C()
                }
                var z = $("#mc-form"),
                    A = z.attr("action");
                z.ajaxChimp({
                ...
                try {
                    ...
                    if (0 < document.cookie.length) {
                        ...
                        if (-1 != P) {
                            ...
                            return -1 == z && (z = document.cookie.length), unescape(document.cookie.substring(P, z))
                        }
                    }
                } catch (A) {
        ...
        handleVerticalMenu: function() {
            $(".category_trigger").click(function() {
                ...
                var y = $(this).closest(".menu-item"),
                    C = y.find(".submenu");
                (768 > roar.getWidthBrowser() || $("html").hasClass("touch")) && (y.hasClass("is_open") ? (y.removeClass("is_open"), C.slideUp()) : (y.addClass("is_open"), C.slideDown()))
            })
        },
            ...
            return $(".quickview .quick_view").magnificPopup({
                ...
                callbacks: {
                    ...
                    ajaxContentAdded: function() {
                        ...
                        C.register("product-quickview-template", theme.Product), roar.initCountdown(), window.show_multiple_currencies && roar.currenciesCallback("#ProductSection-product-quickview-template .money");
                    ...
                    afterClose: function() {
                        console.log(y), "" != y && ($(y).trigger("click"), y = "")
                    }
                }
            }), !1
        },
        mapClearFilter: function() {
            $(".mfilter-box .column").each(function() {
                ...
                0 < y.find("input:checked").length && y.find(".clear").on("click", function(C) {
                    var S = [];
                    Shopify.queryParams.constraint && (S = Shopify.queryParams.constraint.split("+")), y.find("input:checked").each(function() {
                        var I = $(this),
                            T = I.val();
                        if (T) {
                            var P = S.indexOf(T);
                    ...
                    }), S.length ? Shopify.queryParams.constraint = S.join("+") : delete Shopify.queryParams.constraint, roar.filterAjaxClick(), C.preventDefault()
                })
            })
        },
        mapSingleFilter: function() {
            $("body").on("change", ".advanced-filter .field:not(.disable) input", function() {
                var y = $(this).parent(),
                    C = $(this).val(),
                    S = [];
                if (Shopify.queryParams.constraint && (S = Shopify.queryParams.constraint.split("+")), !window.enable_filter_multiple_choice && !y.hasClass("active")) {
                ...
                if (C) {
                    var T = S.indexOf(C);
                    0 > T ? (S.push(C), y.addClass("active")) : (S.splice(T, 1), y.removeClass("active"))
                }
                S.length ? Shopify.queryParams.constraint = S.join("+") : delete Shopify.queryParams.constraint, roar.filterAjaxClick()
            })
        },
        mapSingleCollection: function() {
            $("body").on("click", ".advanced-collection .field", function(y) {
                var C = $(this),
                    S = C.attr("href");
                C.hasClass("active") || (roar.filterAjaxClick(S), $(".advanced-collection .field").removeClass("active"), C.addClass("active"), y.preventDefault())
            })
        },
        ...
        mapSinglePagination: function() {
            $("body").on("click", "#mfilter-content-container .advanced-pagination a", function(y) {
                var C = $(this);
                delete Shopify.queryParams.page, delete Shopify.queryParams.constraint, delete Shopify.queryParams.q, delete Shopify.queryParams.sort_by, roar.filterAjaxClickPaging(C.attr("href")), y.preventDefault()
            })
        },
        mapFilters: function() {
            roar.handleGridList(), roar.mapSingleFilter(), roar.mapSingleCollection(), roar.mapSingleSort(), roar.mapSingleLimit(), roar.mapSinglePagination(), roar.mapClearFilter()
        },
        ...
        filterCreateUrlPaging: function(y) {
            var C = 1,
                S = y.split("page=");
            return 1 < S.length && (C = parseInt(S[1])), roar.updateQueryStringParameter(window.location.href, "page", C)
        },
        ...
        filterGetContent: function(y) {
            $.ajax({
                ...
                success: function(C) {
                    ...
                    $(C).find(".breadcrumb-content").length && $(".breadcrumb-content").html($(C).find(".breadcrumb-content").html()), $(".category-info").remove(), $(C).find(".category-info").length && $("#mfilter-content-container").prepend($(C).find(".category-info")), $(".advanced-collection").empty().html($(C).find(".advanced-collection").html()), $("#sandbox").empty().html($(C).find("#sandbox").html()), $(".mfilter-box .mfilter-content").empty().html($(C).find(".mfilter-box .mfilter-content").html()), $("#mfilter-content-container .advanced-pagination").empty().html($(C).find("#mfilter-content-container .advanced-pagination").html()), $(".page-top").empty().html($(C).find(".page-top").html()), $(".infinite_scoll").length && $(C).find(".infinite_scoll").length && $(".infinite_scoll").removeClass("invisible").empty().html($(C).find(".infinite_scoll").html()), History.pushState({
                        param: Shopify.queryParams
                    }, S, y), setTimeout(function() {
                        $("html,body").animate({
                            scrollTop: $("body #sandbox").offset().top
                        }, 500, "swing")
                    }, 100), $("body").removeClass("is_loading"), roar.mapClearFilter(), roar.handleQuickshop(), roar.handleReviews(), roar.initCountdown(), window.show_multiple_currencies && roar.currenciesCallback("#sandbox span.money")
                },
                error: function() {
        ...
        createVariantsSwatch: function(y, C) {
            var S = [];
            if (window.swatch_size && S.push("Size"), window.swatch_color && (S.push("Color"), S.push("Colour")), 0 < S.length) {
                var I = !1,
                    T = !1,
                    P = 0,
                ...
                for (i = 0; i < y.options.length; i++) {
                    var q = "";
                    if (q = "object" == typeof y.options[i] ? y.options[i].name : y.options[i], I = !1, T = !1, -1 < S.indexOf(q)) {
                        I = !0, P = i;
                        var M = q.toLowerCase();
                        if (/color|colour/i.test(M) && (T = !0), I) {
                            var O = "",
                                N = "";
                            /size/i.test(q.toLowerCase()) && window.size_chart && (N = "<a id=\"size_chart_trigger\" href=\"#\" class=\"sizechart-ctl\" data-ctl-toggle=\"#sizechart-ctl\">" + window.size_chart_txt + "</a>"), O += "<div class=\"swatch " + M + " clearfix\" data-option-index=\"" + P + "\">", O += "<div class=\"header\"><span>" + q + "</span>" + N + "</div><div>";
                            var E = [];
                            for (j = 0; j < y.variants.length; j++) {
                                var B = y.variants[j],
                                    ...
                                    D = "swatch-" + P + "-" + W;
                                0 > E.indexOf(U) && (O += "<div data-value=\"" + U + "\" class=\"swatch-element " + (T ? "color" : "") + W + (B.available ? " available " : " soldout ") + "\">", T && (O += "<div class=\"tooltip\">" + U + "</div>"), O += "<input id=\"" + D + "\" type=\"radio\" name=\"option-" + P + "\" value=\"" + U + "\"" + (0 == j ? " checked " : "") + (B.available ? "" : " disabled") + "/>", T ? (O += "<label for=\"" + D + "\" class=\"img btooltip\" title=\"" + U + "\"><i style=\"background-color:" + W + "; background-image: url(" + z + W + ".png" + A + ")\">", O += "<img class=\"crossed-out\" src=\"" + z + "soldout.png\" />", O += "</i></label>") : (O += "<label for=\"" + D + "\">" + U, O += "<img class=\"crossed-out\" src=\"" + z + "soldout.png\" />", O += "</label>"), O += "</div>", E.push(U))
                            }
                            O += "</div></div>", C.find("#product-variants > select").after(O), C.find(".swatch :radio").change(function() {
        ...
        handleScrollToTop: function() {
            function y(C) {
                var S = $("#scroll-top");
                S.removeClass("off on"), S.addClass("on" == C ? "on" : "off")
            }
            $(window).scroll(function() {
        ...
        handleGridList: function() {
            function y(I) {
                try {
                    if ("list" == I) {
                        ...
                        T.hasClass(I) || (T.removeClass("grid"), T.addClass(I), localStorage.setItem("display", I))
                    } else {
                        var T = $("#mfilter-content-container");
                        T.hasClass(I) || (T.removeClass("list"), T.addClass(I), localStorage.setItem("display", I))
                    }
                } catch (P) {
                    console.log(P.message)
                }
            ...
            try {
                ...
                if (null != C) y("list" == C ? "list" : "grid");
                else {
                    var S = "";
                    $("#mfilter-content-container").hasClass("list") ? S = "list" : $("#mfilter-content-container").hasClass("grid") && (S = "grid"), y("list" == S ? "list" : "grid")
                }
            } catch (I) {
    ...
    roarLookbook = {
        ...
        isProductUrl: function(y) {
            ...
            return S.href = y, console.log(C), console.log(S.hostname), S.hostname == C
        },
                    ...
                    I = $.param(I), $.ajax({
                        ...
                        success: function(T) {
                            ...
                            P.imagesLoaded(function() {
                                C.addClass("roarlookbook_init").attr("data-lookbook", S + y), P.addClass("sfx-fadeIn")
                            })
                        }
                    })
                }
        ...
        resetHotspots: function(y) {
            ...
            C.each(function() {
                ...
                P.fadeOut("fast", function() {
                    P.remove(), I.removeClass("hotspot_init")
                })
            })
        },
            ...
            $(".roarlookbook").on("click", ".hotspot", function() {
                ...
                if (!C.hasClass("hotspot_init")) {
                    var S = C.closest(".roarlookbook"),
                        ...
                        O = "";
                    if ("" == z && "" == M) return !1;
                    if (roarLookbook.resetHotspots(S), O += "<div id=\"" + T + "\" class=\"hotspot-widget hotspot-loading\">", O += "<div class=\"hotspot-content\">", O += "<span class=\"hotspot-close\">\xD7</span>", O += "<div class=\"hotspot-inner\">", "" != A) {
                    ...
                    if ("" != z && (O += "<h3>", O += "" == M ? z : "<a href=\"" + M + "\">" + z + "</a>", O += "</h3>"), "" != q && (O += "<div class=\"price\"><span class=\"money\">" + q + "</span></div>", roarLookbook.isProductUrl(M) && (O += "<div class=\"hotspot-btns\">", O += "<div class=\"hotspot-btn\"><a href=\"" + M + "\">" + theme.apps.details + "</a></div>", O += "<div class=\"hotspot-btn\"><a class=\"roar_add_to_cart\" href=\"" + M + "?add-to-cart=true\">" + theme.apps.buyNow + "</a></div>", O += "</div>")), O += "</div>", O += "</div>", O += "</div>", $(P).length || S.append(O), $(P).imagesLoaded(function() {
                            var B = $(P),
                                U = C.offset().left,
                                W = C.offset().top,
                                D = B.outerWidth(),
                                ...
                                V = S.outerWidth() - (U + D),
                                G = "hotspot-right";
                            50 > V ? (U = U - D - 5, G = "hotspot-left") : U = U + C.outerWidth() + 5, W = W + C.outerHeight() / 2 - F / 2, B.css({
                                left: U - H,
                                top: W - L
                            }).removeClass("hotspot-left").removeClass("hotspot-right").addClass(G), C.addClass("hotspot_init"), B.removeClass("hotspot-loading").fadeIn("fast")
                        }), $(P).find("img").length) {
                        var E = $(P).find("img");
                ...
                var C = $(this),
                    ...
                    T = I.split("-"),
                    P = T[1];
                $(".roarlookbook .hotspot[data-id=\"" + P + "\"]").removeClass("hotspot_init"), S.fadeOut("fast", function() {
                    S.remove()
                })
...
window.theme = window.theme || {}, theme.Sections = function() {
    ...
    _createInstance: function(y, C) {
        ...
        if (C = C || this.constructors[T], !_.isUndefined(C)) {
    ...
    register: function(y, C) {
        this.constructors[y] = C, $("[data-section-type=" + y + "]").each(function(S, I) {
    ...
    return {
        preload: function(z, A) {
            "string" == typeof z && (z = [z]);
            for (var M, q = 0; q < z.length; q++) M = z[q], this.loadImage(this.getSizedImageUrl(M, A))
        },
    ...
    function y(C) {
        this.$container = C.$container, this.product = C.product, this.singleOptionSelector = C.singleOptionSelector, this.originalSelectorId = C.originalSelectorId, this.enableHistoryState = C.enableHistoryState, this.currentVariant = this._getVariantFromOptions(), $(this.singleOptionSelector, this.$container).on("change", this._onSelectChange.bind(this))
    }
    return y.prototype = _.assignIn({}, y.prototype, {
        _getCurrentOptions: function() {
            var C = _.map($(this.singleOptionSelector, this.$container), function(S) {
                var I = $(S),
                    T = I.attr("type"),
                    P = {};
                return "radio" === T || "checkbox" === T ? !!I[0].checked && (P.value = I.val(), P.index = I.data("index"), P) : (P.value = I.val(), P.index = I.data("index"), P)
            });
        ...
        _onSelectChange: function() {
            ...
            this.$container.trigger({
                type: "variantChange",
                variant: C
            }), C && (this._updateMasterSelect(C), this._updateImages(C), this._updatePrice(C), this._updateSKU(C), this.currentVariant = C, this.enableHistoryState && this._updateHistoryState(C))
        },
    ...
    function y(C) {
        ...
        }, $("#ProductJson-" + I).html() && (this.productSingleObject = JSON.parse(document.getElementById("ProductJson-" + I).innerHTML), this._stringOverrides(), this._initVariants(), this._initSwatches(), this._initFeature(), this._initCompact(), this._initStickyImages(), this._initThumbnailsGallery(), this._initImages(), this._initSidebar(), this._initZoom(), this._initGallery(), this._instagramProducts(), this._initQuantity(), this._initTabs(), this._initHandleProduct())
    }
    return y.prototype = _.assignIn({}, y.prototype, {
        ...
        _initHandleProduct: function() {
            0 == $("#main").next("#popup-product-sizechart").length && $("#main").after($("#popup-product-sizechart")), 0 == $("#main").next("#popup-product-question").length && $("#main").after($("#popup-product-question")), $(".button-product-question").click(function() {
                ...
                return $.magnificPopup.open({
                    ...
                    removalDelay: 200
                }), !1, void((0 < $(".quickview .mfp-content").find("#popup-product-question").length || 0 < $(".quickview .mfp-content").find("#popup-product-sizechart").length) && ($(".quickview.mfp-wrap").addClass("_reopen"), $(".quickview.mfp-wrap").data("_qid", I)))
                ...
                return $.magnificPopup.open({
                    ...
                    mainClass: "popup-module mfp-with-zoom",
                    removalDelay: 200
                }), !1, void((0 < $(".quickview .mfp-content").find("#popup-product-sizechart").length || 0 < $(".quickview .mfp-content").find("#popup-product-question").length) && ($(".quickview.mfp-wrap").addClass("_reopen"), $(".quickview.mfp-wrap").data("_qid", I)))
                ...
                return $("#myCarouselRelated .carousel-inner").trigger("next.owl.carousel"), !1
            }), $("#myCarouselRelated_prev").click(function() {
                return $("#myCarouselRelated .carousel-inner").trigger("prev.owl.carousel"), !1
        ...
        _initImages: function() {
            ...
            if ("left" == this.settings.product_design || "bottom" == this.settings.product_design || "sidebar" == this.settings.product_design || "full-screen" == this.settings.product_design) {
                if (0 < $(C.selectors.productThumbImages).length) {
                    ...
                    var T = "0" != $(C.selectors.productThumbImages).data("vertical"),
                        P = 6;
                    $(".product-page-section").hasClass("product-has-sidebar") && (P = 3), $(C.selectors.productThumbImages).closest("#shopify-section-product-quickview-template").length && (P = 4), I.not(".slick-initialized").slick({
                        slidesToShow: P,
                        slidesToScroll: 1,
                        asNavFor: S,
                        focusOnSelect: !0,
            ...
            } else S.not(".slick-initialized").slick({
                rtl: window.rtl,
                slidesToShow: 1,
                slidesToScroll: 1,
                infinite: !1,
        ...
        _initThumbnailsGallery: function() {
            ...
            "gallery" == this.settings.product_design && $(".thumbnail-gallery-item").on("click", function() {
                var S = $(this);
                S.hasClass("active") || ($(".thumbnail-gallery-item").removeClass("active"), S.addClass("active"), $(".thumbnail-gallery-item").each(function(I) {
                    if ($(this).attr("id") == S.attr("id")) return void C.slick("slickGoTo", I, !0)
                }))
            })
        },
        ...
        _initFeature: function() {
            if (0 < $(this.selectors.product + " .product-video-button a").length && $(this.selectors.product + " .product-video-button a").unbind("click") && $(this.selectors.product + " .product-video-button a").click(function(O) {
                    ...
                    }), (0 < $(".quickview .mfp-content").find(".product-360-view-wrapper").length || 0 < $(".quickview .mfp-content").find(".mfp-iframe-scaler").length) && ($(".quickview.mfp-wrap").addClass("_reopen"), $(".quickview.mfp-wrap").data("_qid", E))
                }), 0 < $(this.selectors.product + " .product-360-button a").length) {
                for (var q, S = $(this.selectors.product + " .product-360-button a").data("id"), I = $(this.selectors.product + " .product-360-button a").data("_qid"), T = $(this.selectors.product + " .product-360-button a"), P = [], z = JSON.parse(document.getElementById("threed-id-" + this.sectionId).innerHTML), A = 1; 72 >= A; A++) q = "f" + A, z[q] && P.push(z[q]);
                if (0 < P.length) {
                    var M = P.length;
                    xxx = $(this.selectors.threedId).ThreeSixty({
                        ...
                        navigation: !0,
                        onReady: function() {
                            0 == $("#main").next(".product-360-view-wrapper").length && $("#main").after($(S)), T.unbind("click") && T.click(function() {
                                $.magnificPopup.open({
                                    items: {
                                        src: S,
                                        type: "inline"
        ...
        _initCompact: function() {
            if (0 < $(".product-accordion").length) {
                ...
                S.each(function() {
                    ...
                    T.data("height", P), I.data("height", P + z)
                }), S.each(function() {
                    var I = $(this),
                        T = I.find(".title"),
                        P = T.innerHeight(),
                        z = I.find(".content").outerHeight(),
                        A = T.parent(".accordion-item");
                    T.data("height", P), I.data("height", P + z), A.hasClass("active") && A.height(A.data("height"))
                }), C.on("click", ".accordion-item > .title", function() {
                    var I = $(this),
                        T = I.parent(".accordion-item");
                    T.hasClass("active") || S.closest(".active").removeClass("active").height(I.data("height")), T.toggleClass("active"), T.hasClass("active") ? T.height(T.data("height")) : T.height(I.data("height"))
                })
            }
        },
        _initStickyImages: function() {
            function C() {
                O = $(window).height(), q.each(function() {
                    M = $(this).offset().top, D > M - O + 20 && $(this).addClass("animate-images")
                })
            }

            function S() {
                D = $(window).scrollTop(), V = D + E + W, z = T.width(), H = T.offset().left + 15, F = A.offset().top, L = F + N, z > B && (U = (z - B) / 2, H += U), D + E >= F ? (T.addClass("block-sticked"), P.css({
                    top: E,
                    left: H,
                    width: z,
                    position: "fixed",
                    transform: "translateY(-20px)"
                })) : (T.removeClass("block-sticked"), P.css({
                    top: "auto",
                    left: "auto",
                    width: "auto",
                    position: "relative",
            ...
            function I() {
                O = $(window).height(), W = T.outerHeight(), N = A.outerHeight(), W < O - E ? T.addClass("in-viewport").removeClass("not-in-viewport") : T.removeClass("in-viewport").addClass("not-in-viewport"), S(), C()
            }
            if ($("body").hasClass("fastor-product-design-sticky")) {
                var M, U, T = $(".product-summary"),
                    P = T.find(".entry-summary"),
                    z = T.width(),
                    A = $(".fastor-images"),
                    q = A.find(".shopify-product-gallery__wrapper a"),
                    O = $(window).height(),
                    N = A.outerHeight(),
                    E = 130,
                    B = 600,
            ...
            (function(S) {
                ...
                for (var T = function(B) {
                        for (var F, H, L, V, U = $(B).find(".photoswipe-item").get(), W = U.length, D = [], G = 0; G < W; G++)
                            if (F = U[G], 1 === F.nodeType)
                                if (H = F.children[0], L = H.getAttribute("data-size").split("x"), "video" == $(H).data("type")) {
                                    ...
                                    w: parseInt(L[0], 10),
                                    h: parseInt(L[1], 10)
                                }, 1 < F.children.length && (V.title = $(F).find(".caption").html()), 0 < H.children.length && (V.msrc = H.children[0].getAttribute("src")), V.el = F, D.push(V);
                        return D
                    }, P = function B(U, W) {
                        ...
                        } else L.index = parseInt(B, 10) - 1;
                        isNaN(L.index) || (W && (L.showAnimationDuration = 0), H = new PhotoSwipe(F, PhotoSwipeUI_Default, V, L), H.init(), H.listen("beforeChange", function() {
                    ...
                    }, M = document.querySelectorAll(S), O = 0, N = M.length; O < N; O++) M[O].setAttribute("data-pswp-uid", O + 1), M[O].onclick = z;
                var E = A();
        ...
        _initZoom: function() {
            if ($(".easyzoom").length)
                if (1024 < $(window).width()) var C = $(".easyzoom:not(.feature-video)").easyZoom({
                        loadingNotice: "",
                        errorNotice: "",
                        preventClicks: !1
                    }),
                    S = C.data("easyZoom");
                else $(".easyzoom a").click(function(I) {
                    I.preventDefault()
                })
        },
        _initSidebar: function() {
            var C = this;
            $sidebarSlide = $(C.selectors.sidebarSlide), 0 < $sidebarSlide.length && $sidebarSlide.each(function() {
                var S = $(this),
        ...
        _initSwatches: function() {
            var C = this.productSingleObject,
                S = [];
            if ("1" == this.settings.swatch_size && S.push("Size"), S.push("size"), "1" == this.settings.swatch_color && (S.push("Color"), S.push("Colour"), S.push("color"), S.push("colour")), 0 < S.length) {
                var I = !1,
                    T = !1,
                    P = 0,
                ...
                for (i = 0; i < C.options.length; i++) {
                    var q = "",
                        ...
                        U = "",
                        W = "img btooltip";
                    if (q = "object" == typeof C.options[i] ? C.options[i].name : C.options[i], I = !1, T = !1, -1 < S.indexOf(q)) {
                        I = !0, P = i;
                        var D = q.toLowerCase();
                        if (/color|colour/i.test(D) && (T = !0), I) {
                            var H = [];
                            for (j = 0; j < C.variants.length; j++) {
                                var L = C.variants[j],
                                    V = this.htmlEntities(L.options[P]),
                                    G = this.convertToSlug(V);
                                0 > H.indexOf(V) && ("color" != D && "colour" != D ? (U = V, W = "btooltip") : U = "<i style=\"background-color:" + V + "; background-image: url(" + z + G + ".png" + A + ")\"></i>", B = $(this.selectors.singleOptionSelectorId + "-" + P).val() == V ? "selected " : "", O = O + "<div class=\"swatch-element " + D + G + " available\"><input data-id=\"" + this.selectors.singleOptionSelectorId + "-" + P + "\" data-value=\"" + V + "\"  class=\"swatch-radio " + B + "\" id=\"swatch-" + P + "-" + G + "\" type=\"radio\" name=\"option-" + P + "\" value=\"" + V + "\"><label for=\"swatch-" + P + "-" + G + "\" class=\"" + W + "\" title=\"" + V + "\">" + U + "</label></div>", H.push(V))
                            }
                            M = "<div class=\"" + this.selectors.singleOptionSwatches + " wrapper-swatches swatch " + D + "\" data-attribute_name=\"attribute_pa_" + D + "\"><div>" + O + "</div></div>", N = $(this.selectors.singleOptionSelectorId + "-" + P), E = $(this.selectors.variationSelector + "-" + P), "" != M && (N.after(M), N.hide(), E.addClass("hide-choose-option"))
                        }
                    }
                }
            }
            var K = "",
                Q = "." + this.selectors.singleOptionSwatches + " .swatch-radio";
            0 < $("." + this.selectors.singleOptionSwatches).length && (K = $(Q), K.unbind("click"), K.on("click", function() {
                var J = $(this).data("id");
                console.log($(this).data("value") + " - " + $(J).val()), $(this).data("value") != $(J).val() && ($(J).val($(this).data("value")).trigger("change"), $(J).closest(".selector-wrapper").find(".swatch-radio").removeClass("selected"), $(this).addClass("selected"))
            }))
        },
        ...
        _initVariants: function() {
            ...
            this.variants = new slate.Variants(C), this.$container.on("variantChange" + this.settings.namespace, this._updateAddToCart.bind(this)), this.$container.on("variantImageChange" + this.settings.namespace, this._updateImages.bind(this)), this.$container.on("variantPriceChange" + this.settings.namespace, this._updatePrice.bind(this)), this.$container.on("variantSKUChange" + this.settings.namespace, this._updateSKU.bind(this))
        },
        _updateAddToCart: function(C) {
            var S = C.variant;
            S ? ($(this.selectors.productPrices).removeClass("invisible").attr("aria-hidden", "true"), $(".variations_button").removeClass("hide"), S.available ? ($(this.selectors.addToCart).prop("disabled", !1).toggleClass("hide", !1), $(this.selectors.addToCart).val(theme.strings.addToCart), $(this.selectors.stockText).html(theme.strings.inStock).removeClass("out-of-stock unavailable").addClass("in-stock"), "shopify" == S.inventory_management && "continue" != S.inventory_policy && (0 < S.inventory_quantity && 1 == parseInt(theme.inventory) ? $(this.selectors.stockText).html(S.inventory_quantity + " " + theme.strings.inStock) : $(this.selectors.stockText).html(theme.strings.inStock))) : ($(this.selectors.addToCart).prop("disabled", !0).toggleClass("hide", !1), $(this.selectors.addToCart).val(theme.strings.soldOut), $(this.selectors.stockText).html(theme.strings.outStock).removeClass("in-stock unavailable").addClass("out-of-stock"))) : ($(".variations_button").addClass("hide"), $(this.selectors.addToCart).prop("disabled", !0).toggleClass("hide", !0), $(this.selectors.addToCart).val(theme.strings.unavailable), $(this.selectors.stockText).html(theme.strings.unavailable).removeClass("in-stock").addClass("out-of-stock unavailable"), $(this.selectors.productPrices).addClass("invisible").attr("aria-hidden", "false"))
        },
        _updateImages: function(C) {
            var S = C.variant,
                I = this,
            ...
            $(this.selectors.productFeaturedImage).each(function() {
                ...
                if (0 <= q.indexOf(P) && !A.closest(".slick-slide").hasClass("slick-cloned")) {
                    ...
                    if ("carousel" == T ? M.slick("slickGoTo", O) : M.slick("slickGoTo", O, !0), "scroll" == T) {
        ...
        _updatePrice: function(C) {
            var S = C.variant;
            if ($(this.selectors.originalPrice).html("<span class=\"money\">" + Shopify.formatMoney(S.price, window.money_format) + "</span>"), S.compare_at_price > S.price) {
                if ($(this.selectors.productPrices).addClass("has-sale"), $(this.selectors.productPrices).removeClass("not-sale"), $(this.selectors.comparePrice).html("<span class=\"money\">" + Shopify.formatMoney(S.compare_at_price, window.money_format) + "</span>").removeClass("hide"), $(this.selectors.saleLabel).find("span").text(theme.strings.sale), "" != theme.sale_percentages) {
    ...
    function y(C) {
        ...
        this.MegaMenu = $("#megamenu-" + I), this.megaMenuNamspace = "#megamenu-" + I, this.megaMenuId = $("#shopify-section-" + I), 0 < $(".section-megamenu-content").length && $(".section-megamenu-content").each(function() {
            ...
            0 < $(this).closest(".shopify-section").length && (!$(this).closest(".shopify-section").hasClass(P) && $(this).closest(".shopify-section").addClass(P), $(this).closest(".shopify-section").removeClass("hidden"))
        }), 0 < $("#header-phantom .shopify-section").length && $("#header-phantom .shopify-section").each(function() {
            $(this).removeClass("shopify-section")
        }), this._init()
    }
    return y.prototype = _.assignIn({}, y.prototype, {
        _init: function() {
            this._products(), this._handleMegaMenu(), this._handleVermenuCategory()
        },
        _products: function() {
            0 < $("#top > .background > .pattern > .megamenu-background #megamenu-header-menu1.products-carousel-megamenu").length && $("#top > .background > .pattern > .megamenu-background #megamenu-header-menu1.products-carousel-megamenu").each(function() {
                var A, C = $(this).data("_id"),
                    S = $(this).data("_one"),
                    I = $(this).data("_two"),
                    T = $(this).data("_three"),
                    P = $(this).data("_four"),
                    z = $(".productsCarousel" + C).get(0);
                $(".productsCarousel" + C + "_next").click(function() {
                    return z.trigger("next.owl.carousel"), !1
                }), $(".productsCarousel" + C + "_prev").click(function() {
                    return z.trigger("prev.owl.carousel"), !1
                }), A = z.owlCarousel({
                    responsive: {
                        0: {
                            items: S
                    ...
                    A.trigger("destroy.owl.carousel").removeClass("owl-carousel owl-loaded"), A.find(".owl-stage-outer").children().unwrap(), A = z.owlCarousel({
                        responsive: {
                            0: {
                                items: S
                            },
            ...
            "yes" == window.megamenu_responsive_design && 992 > $(window).width() && (window.megamenu_responsive = !0), $("ul.megamenu > li").each(function() {
                ...
                if (0 == window.megamenu_responsive) {
                    if (window.megamenu_active = $(this), window.megamenu_hover = !0, $("ul.megamenu > li").removeClass("active"), $(this).addClass("active"), window.rtl) {
                        ...
                        if ($(".header-type-3").length) var T = $("#top .container"),
                            P = $(window).width() - (T.offset().left + T.outerWidth());
                        else var T = $(".overflow-megamenu"),
                            P = $(window).width() - (T.offset().left + T.outerWidth());
    ...
    function y(C) {
        var S = this.$container = $(C),
            I = this.sectionId = S.attr("data-section-id"),
            T = S.attr("data-section-type");
        this.bannerId = $("#shopify-section-" + I), this.bannerNamspace = "#banner-" + I, this.placement_fullwidth = $(this.bannerNamspace).data("placement_fullwidth"), this._init()
    }
    return y.prototype = _.assignIn({}, y.prototype, {
        _init: function() {
            if ("1" == this.placement_fullwidth && !window.sidebar) {
    ...
    return y.prototype = _.assignIn({}, y.prototype, {
        _init: function() {
            if ("1" == this.option.slider_align_top ? $(".templateIndex").addClass("slider-align-top") : $(".templateIndex").removeClass("slider-align-top"), this._handleSlideshow(), this._initResize(), "1" == this.option.full_width && !window.sidebar) {
                var C = this.sectionId;
                onFullWidthOption(C)
            }
        ...
        _handleSlideshow: function() {
            ...
            if (this.slideShow.length) {
                ...
                C = M.data("afx-head"), S = M.data("afx-cap"), I = M.data("afx-cta"), T = M.data("afx-sticker"), P = M.data("dfx-head"), z = M.data("dfx-cap"), A = M.data("dfx-cta"), q = M.data("dfx-sticker")
            }
            ...
            if (this.slideShow.length) {
                ...
                $(C + " .slide-caption").each(function() {
                    ...
                    if (1 == T) {
                        ...
                        if ("undefined" == typeof z && (z = "auto"), "undefined" == typeof q && (q = "auto"), "undefined" == typeof P && (P = "auto"), "undefined" == typeof A && (A = "auto"), 1200 > S && ("auto" != P && 0 > P.toString().indexOf("%") && (P = P * S / 1200), "auto" != z && 0 > z.toString().indexOf("%") && (z = z * S / 1200), "auto" != A && 0 > A.toString().indexOf("%") && (A = A * S / 1200), "auto" != q && 0 > q.toString().indexOf("%") && (q = q * S / 1200), M = M * S / 1200), $(this).css({
                                top: z,
                                left: P,
                                bottom: q,
                                right: A,
                                ...
                                width: "auto",
                                "line-height": 1
                            }), P = $(this).data("left"), 0 < $(".common-home.show-vertical-megamenu .vertical .megamenu-wrapper").length && 991 < S && "undefined" != typeof P && "auto" != P && 0 > P.toString().indexOf("%")) {
                            var E = P + N;
                            1280 > S && (E = N + P * S / 1280);
                            var B = $(".common-home.show-vertical-megamenu .vertical .megamenu-wrapper"),
                                U = B.offset().left + B.outerWidth();
                            U > E && (E = U + 30), $(this).css("left", E)
                        }
                    } else {
                        var W = $(this).height();
                        $(this).css({
        ...
        _mockupCaptionSlider: function() {
            if (this.slideShow.length) {
                ...
                767 <= T && 0 == S && 0 < I && $(C + " .slide-body").css("height", I), $(C + " .caption-content").each(767 > T ? function() {
                    var z = $(this).data("min"),
                        A = $(this).data("max"),
                        q = A;
                    50 < A && (q = 50), z > q && (q = z), $(this).css({
                        "font-size": q
                    })
                } : function() {
                    var z = $(this).data("max");
                ...
                $(C + " .slide-caption").each(function() {
                    ...
                    if (1 == z) {
                        ...
                        if ("undefined" == typeof q && (q = "auto"), "undefined" == typeof O && (O = "auto"), "undefined" == typeof A && (A = "auto"), "undefined" == typeof M && (M = "auto"), 1200 > T && ("auto" != A && 0 > A.toString().indexOf("%") && (A = A * T / 1200), "auto" != q && 0 > q.toString().indexOf("%") && (q = q * T / 1200), "auto" != M && 0 > M.toString().indexOf("%") && (M = M * T / 1200), "auto" != O && 0 > O.toString().indexOf("%") && (O = O * T / 1200), N = N * T / 1200), $(this).css({
                                top: q,
                                left: A,
                                bottom: O,
                                right: M,
                                ...
                                width: "auto",
                                "line-height": 1
                            }), A = $(this).data("left"), 0 < $(".common-home.show-vertical-megamenu .vertical .megamenu-wrapper").length && 991 < T && "undefined" != typeof A && "auto" != A && 0 > A.toString().indexOf("%")) {
                            var U = A + B;
                            1280 > T && (U = B + A * T / 1280);
                            var W = $(".common-home.show-vertical-megamenu .vertical .megamenu-wrapper"),
                                D = W.offset().left + W.outerWidth();
                            D > U && (U = D + 30), $(this).css("left", U)
                        }
                    } else {
                        var F = $(this).height();
                        $(this).css({
    ...
    return y.prototype = _.assignIn({}, y.prototype, {
        _init: function() {
            ...
            0 < this.tabItem.length && this.tabItem.each(function() {
                ...
                1 < parseInt(S._tabcount) ? (C._initTab(), S._ptab_carousel && C._initMultiSlide(S), C._initMultiSlides(S)) : (S._ptab_carousel && C._initSlide(S), C._initSlides(S))
            })
        },
        _initTab: function() {
    ...
    return y.prototype = _.assignIn({}, y.prototype, {
        _init: function() {
            ...
            if (0 < this.tabItem.length && this.tabItem.each(function() {
                    ...
                    1 < parseInt(T._tabcount) ? (C._initTab(), C._initMultiSlide(T)) : C._initSlide(T)
    ...
    return y.prototype = _.assignIn({}, y.prototype, {
        ...
        _initProductTab: function() {
            ...
            0 < $(".ag-products-tabs-" + C).length && $(".ag-products-tabs-" + C).each(function() {
                ...
                1 < parseInt(I) ? (S._initTab(T), S._initMultiSlide(T)) : S._initSlide(T)
            })
        },
        _initTab: function(C) {
            ...
            0 < $(".ag-product-tab-item-" + C).length && $(".ag-product-tab-item-" + C).each(function() {
                ...
                if (I) {
                    ...
                    0 < $("#myCarousel" + S + "_next").length && $("#myCarousel" + S + "_next").click(function() {
                        return P.trigger("next.owl.carousel"), !1
                    }), 0 < $("#myCarousel" + S + "_prev").length && $("#myCarousel" + S + "_prev").click(function() {
                        return P.trigger("prev.owl.carousel"), !1
    ...
    function y(C) {
        var S = this.$container = $(C),
            I = this.sectionId = S.attr("data-section-id"),
            T = S.attr("data-section-type");
        this.latestBlogId = $("#shopify-section-" + I), this.latestBlog = $("#latest_blog-" + I), this.latestBlogNamspace = "#latest_blog-" + I, this.placement_fullwidth = this.latestBlog.data("placement_fullwidth"), this._init()
    }
    return y.prototype = _.assignIn({}, y.prototype, {
        _init: function() {
            if ("1" == this.placement_fullwidth && !window.sidebar) {
    ...
    return y.prototype = _.assignIn({}, y.prototype, {
        ...
        _initMobile: function() {
            function C() {
                $(document.body).removeClass("open-canvas-panel"), $(".fastor-off-canvas-panel, #primary-mobile-nav").removeClass("open")
            }
            var S = this.mobileNav;
            $("header").on("click", "#un-navbar-toggle", function(I) {
                I.preventDefault(), S.toggleClass("open"), $(document.body).toggleClass("open-canvas-panel")
            }), S.on("click", ".mobile-child-menu", function(I) {
                I.preventDefault(), $(this).closest("li").siblings().find("ul").slideUp(), $(this).closest("li").siblings().removeClass("active"), $(this).closest("li").siblings().find("li").removeClass("active"), $(this).closest("li").children("ul").slideToggle(), $(this).closest("li").toggleClass("active")
            }), S.on("click", ".close-canvas-mobile-panel", function(I) {
                I.preventDefault(), C()
            }), $(window).on("resize", function() {
                991 < $(window).width() && S.hasClass("open") && (S.removeClass("open"), $(document.body).removeClass("open-canvas-panel"))
            })
        },
        onUnload: function() {
    ...
    return y.prototype = _.assignIn({}, y.prototype, {
        _init: function() {
            var C = this;
            C._initScroll(), C._initCompact(), C._initEvents(), $(window).resize(function() {
        ...
        _initScroll: function() {
            $(window).on("scroll", function() {
                ...
                $(window).scrollTop() > C ? $(document.body).addClass("sticky-product-variants-mobile") : ($(document.body).removeClass("sticky-product-variants-mobile"), $(".product-variants-mobile").hasClass("active") && $(".product-variants-mobile").height($(".variants-header").data("height")))
            })
        },
        _initCompact: function() {
            if (0 < $(".product-variant-mobile-section").length) {
                ...
                S.each(function() {
                    ...
                    P.hasClass("active") || S.closest(".active").removeClass("active").height(I.data("height")), P.toggleClass("active"), P.hasClass("active") ? P.height(P.data("height")) : P.height(T.data("height"))
                })
            }
        },
        _initEvents: function() {
            ...
            0 < this.addCartId.length && (this.addCartId.unbind("click"), this.addCartId.on("click", function() {
                $("#ProductSelect-product-template.variation-select").val(C), $("#AddToCart-product-template").trigger("click")
            })), 0 < this.addCartClass.length && (this.addCartClass.unbind("click"), this.addCartClass.on("click", function() {
                var S = $(this).data("id");
                $("#ProductSelect-product-template.variation-select").val(S), $("#AddToCart-product-template").trigger("click")
            }))
        },
        onUnload: function() {
...
function _force_full_width(y) {
    ...
    if (!window.rtl) {
        if (0 < C.size()) {
            ...
            var S = C.offset();
            C.css("left", "-" + S.left + "px"), C.find(".container").css("padding-left", S.left), C.find(".container").css("padding-right", S.left)
        }
    } else if (0 < C.size()) {
        C.width($("body").width()), C.css("right", "0px");
        var S = C.offset();
        C.css("right", "-" + -1 * S.left + "px"), C.find(".container").css("padding-left", -1 * S.left), C.find(".container").css("padding-right", -1 * S.left)
    }
    var I = $(".standard-body .fixed #shopify-section-" + y);
    if (!window.rtl) {
        if (0 < I.size()) {
            I.width($(".standard-body .fixed .pattern").width()), I.css("left", "0px");
            var S = I.offset(),
                T = $(".standard-body .fixed .pattern").offset(),
                P = S.left - T.left;
            I.css("left", "-" + P + "px"), I.find(".container").css("padding-left", P), I.find(".container").css("padding-right", P)
        }
    } else if (0 < I.size()) {
        I.width($(".standard-body .fixed .pattern").width()), I.css("right", "0px");
        var S = I.offset(),
            T = $(".standard-body .fixed .pattern").offset(),
            P = S.left - T.left;
        I.css("right", "-" + -1 * P + "px"), I.find(".container").css("padding-left", -1 * P), I.find(".container").css("padding-right", -1 * P)
    }
    var z = $(".standard-body .fixed2 #shopify-section-" + y);
    if (0 < z.size()) {
        z.width($("body").width()), z.css("left", "0px");
        var S = z.offset();
        z.css("left", "-" + S.left + "px"), z.find(".container").css("padding-left", S.left), z.find(".container").css("padding-right", S.left)
    }
    ...
    if (!window.rtl) {
        if (0 < A.size()) {
            ...
            var S = A.offset(),
                ...
                P = S.left - T.left;
            A.css("left", "-" + P + "px"), A.find(".container").css("padding-left", P), A.find(".container").css("padding-right", P)
        }
    } else if (0 < A.size()) {
